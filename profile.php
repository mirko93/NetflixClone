...
<div class="settingsContainer column">
    <div class="formSection">
        <form action="" method="POST">
            ...
            <button type="submit" name="saveDetailsButton">Save</button>
        </form>
    </div>
    ...
    <div class="formSection">
        <form action="" method="POST">
            ...
            <button type="submit" name="savePasswordButton">Save</button>
        </form>
    </div>
    ...
    <div class="formSection">
        ...
        if ($user->getIsSubscribed()) {
            ...
            echo "<a href='billing.php'>Subscribe to Netflix-Clone";
        }
        ?>
    </div>
</div>